	...
	<script type="text/javascript">
		$(function(){
			$("#header_search-btn").click(function(){
				var $in=$("#header_search-content").val();
				var url = "user/selectUserMessage";
				var args = {"in" : $in};
				var $table=$("#testTable");
				$.post(url,args,function(data){
					for(var i=0;i<data.length;i++){
						var $tr=$("<tr class='tr'></tr>");
						$("<td>"+data[i].uid+"</td>").appendTo($tr);
						$("<td>"+data[i].name+"</td>").appendTo($tr);
						$("<td>"+data[i].group+"</td>").appendTo($tr);
						$table.append($tr);
					}
				});
			});
...
<body>
	<div id="layout">
			...
			<div id="header_container">
				...
				<div id="header_search">
					<form action="" method="post">
						...
						<button type="button" id="header_search-btn">
		...
		<div id="content">
			<table border="1" style="width:50%" id="testTable"></table>
		</div>
		<footer>
			<div>
